...
public class LayoutTest2 extends BrowserFactory {
    ...
    driver.findElement(By.cssSelector(".signup-registration")).click();
    File file2 = new File(folder.getAbsolutePath() + "\\screen2.png");
    Screenshot screenshot = new AShot().shootingStrategy(ShootingStrategies.viewportPasting(1000)).takeScreenshot(driver());
    ImageIO.write(screenshot.getImage(), "png", file2);
    int diff2 = getScreenshotsDiff(screenshot, "screen", 15);
    System.out.println("DIFF");
    System.out.println(diff2);
    Assert.assertTrue(diff2 <= 20, "DIFF" + diff2);
    }
}